...
class _HomePageState extends State<HomePage> {
  ...
  // --- LOGIQUE DE RANGEMENT DANS LES DOSSIERS (ORIGINE) ---
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Ranger dans une liste",
              ...
              if (favoriteLists.isEmpty)
                const Padding(
                  ...
                  child: Text(
                      "Vous n'avez pas encore de listes.\nCréez-en une dans l'onglet Favoris !",
                        ...
                        onTap: () async {
                          if (!dejaPresent) {
                            ...
                            await prefs.setString(
                                keyLists, jsonEncode(favoriteLists));
                            if (context.mounted) {
  ...
  // --- LOGIQUE COULEURS DIFFICULTÉ (ORIGINE) ---
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            if (controller.isLoading)
              ...
              const SliverFillRemaining(
                  child: Center(child: Text("Aucune recette trouvée...")))
            else ...[
              SliverToBoxAdapter(
                child: Padding(
              ...
              SliverPadding(
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => _buildRecipeCardV2(
                        context, controller.currentPlats[index], controller),
      ...
      children: [
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                "Le plat de tes rêves",
                style: TextStyle(
                  fontSize: 16, 
                  fontWeight: FontWeight.w500,
                  color: kDeepGreen.withOpacity(0.6),
                  letterSpacing: 0.5,
                ),
              ),
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(text: "ou le "),
                    TextSpan(
                      text: "miracle\ndu frigo ?",
                      style: TextStyle(color: kOliveColor), // Utilise ta couleur olive pour le peps
                    ),
                  ],
                ),
              ),
        ...
        Container(
          ...
          child: IconButton(
            icon: Icon(Icons.settings_outlined, size: 24, color: kDeepGreen),
  ...
  Widget _buildModeSelector(HomePageController controller) {
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            _modeButton("Découverte", !controller.isRecommendationMode,
                () => controller.setMode(false)),
            _modeButton("Pour vous", controller.isRecommendationMode,
  ...
  Widget _buildRecipeCardV2(
      BuildContext context, Plat plat, HomePageController controller) {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      // On remet la logique couleur/texte de plat.cuisine
                      Icon(
                        Icons.circle,
                        size: 10,
